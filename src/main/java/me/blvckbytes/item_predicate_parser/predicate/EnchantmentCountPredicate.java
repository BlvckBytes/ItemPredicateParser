...
import me.blvckbytes.item_predicate_parser.translation.keyed.EnchantmentCountKey;
import org.jetbrains.annotations.Nullable;

public record EnchantmentCountPredicate(
  Token token,
  TranslatedLangKeyed<EnchantmentCountKey> translatedLangKeyed,
  IntegerToken amountArgument
) implements ItemPredicate {

  @Override
  public @Nullable ItemPredicate testForFailure(PredicateState state) {
    if (amountArgument.matches(state.getEnchantments().size()))
      return null;
  ...
  public boolean equals(Object other) {
    if (!(other instanceof EnchantmentCountPredicate otherPredicate))
      return false;
